...
__webpack_require__.g.$ = __webpack_require__.g.jQuery = __webpack_require__.g.jquery = $;

__webpack_require__(/*! ./init/comments-work */ "./js/init/comments-work.js");

/***/ }),

/***/ "./js/init/comments-work.js":
/*!**********************************!*\
  !*** ./js/init/comments-work.js ***!
  \**********************************/
/***/ (() => {
...
$(document).on('submit', 'form.js-xhr-comments-form', function (e) {
  ...
  $.ajax({
    ...
    success: function success(result) {
      ...
      if ((_result$success = result.success) !== null && _result$success !== void 0 ? _result$success : false) {
        var selector = $form.data('xhr-comments-selector'),
            $container = $(selector);
...
var loadComments = function loadComments($container) {
  var url = $container.data('xhr-comments-url');
...
var loadHtml = function loadHtml($container, url) {
  $.ajax({
    url: url,
